...
//-----------------------------------------------------------------------------
    ...
    if (y2 >= lineHeight) {
//項目1 右下-------------------------------------------------------------------
        this.drawText(BBSWItem1T, rect.x + 495, y2 - 30, BBSWTF1 - 10);
        if (BBSWItem1 == 1) {
            this.drawText(info.title, rect.x + 495 + BBSWTF1, y2 - 2, 266 - BBSWTF1, 'right');//rect.x - 7, y2 - 2, rect.width
        } else if (BBSWItem1 == 2) {
            this.drawText(info.playtime, rect.x + 495 + BBSWTF1, y2 - 30, 266 - BBSWTF1, 'right');
        } else if (BBSWItem1 == 3) {
...
//-----------------------------------------------------------------------------
//項目2 右上-------------------------------------------------------------------
        this.drawText(BBSWItem2T, rect.x + 495, y2 - 64, BBSWTF2 - 10);
        if (BBSWItem2 == 1) {
            ...
            this.drawText(info.mapname, rect.x + 495 + BBSWTF2, y2 - 64, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 4) {
...
//-----------------------------------------------------------------------------
//項目3 左下-------------------------------------------------------------------
        this.drawText(BBSWItem3T, rect.x + 215, y2 - 30, BBSWTF3 - 10);
        if (BBSWItem3 == 1) {
            ...
            this.drawText(info.gold + TextManager.currencyUnit, rect.x + 215 + BBSWTF3, y2 - 30, 266 - BBSWTF3, 'right');
        } else if (BBSWItem3 == 5) {
...
//-----------------------------------------------------------------------------
//項目4 左上-------------------------------------------------------------------
        this.drawText(BBSWItem4T, rect.x + 215, y2 - 64, BBSWTF4 - 10);
        if (BBSWItem4 == 1) {
            ...
            this.drawText(info.savecount, rect.x + 215 + BBSWTF4, y2 - 66, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 6) {
